...
export const ClientSchema = z.object({
  ...
  graceDownKbps: z.number().int().nullable().optional(),
  graceHours: z.number().int().nullable().optional(),
  graceQuotaBytes: z.number().int().nullable().optional(),
  graceUpKbps: z.number().int().nullable().optional(),
  ...
  security: z.string(),
  speedLimitDownKbps: z.number().int().nullable().optional(),
  speedLimitKbps: z.number().int(),
  speedLimitUpKbps: z.number().int().nullable().optional(),
  subId: z.string(),
  tgId: z.number().int(),
  totalExhaustAction: z.string().nullable().optional(),
  totalExhaustDownKbps: z.number().int().nullable().optional(),
  totalExhaustUpKbps: z.number().int().nullable().optional(),
  totalGB: z.number().int(),
  totalOverageMultiplierBps: z.number().int().nullable().optional(),
  trafficReset: z.enum(['never', 'hourly', 'daily', 'weekly', 'monthly']).optional(),
  trafficResetDay: z.number().int().min(1).max(31).optional(),
  updated_at: z.number().int().optional(),
  windowExhaustAction: z.string().nullable().optional(),
  windowExhaustDownKbps: z.number().int().nullable().optional(),
  windowExhaustUpKbps: z.number().int().nullable().optional(),
  windowHours: z.number().int(),
  windowMode: z.string(),
  windowOverageMultiplierBps: z.number().int().nullable().optional(),
  windowQuotaBytes: z.number().int(),
});
...
export const ClientInboundSchema = z.object({
  ...
  speedLimitKbps: z.number().int(),
  speedLimitUpKbps: z.number().int().nullable().optional(),
  windowExhaustAction: z.string(),
  windowExhaustDownKbps: z.number().int(),
  windowExhaustUpKbps: z.number().int(),
  windowHours: z.number().int(),
  windowMode: z.string(),
  windowOverageMultiplierBps: z.number().int(),
  windowQuotaBytes: z.number().int(),
});
...
export const ClientRecordSchema = z.object({
  ...
  graceDownKbps: z.number().int(),
  graceHours: z.number().int(),
  graceQuotaBytes: z.number().int(),
  graceUpKbps: z.number().int(),
  group: z.string(),
  id: z.number().int(),
  ...
  subId: z.string(),
  tgId: z.number().int(),
  totalExhaustAction: z.string(),
  totalExhaustDownKbps: z.number().int(),
  totalExhaustUpKbps: z.number().int(),
  totalGB: z.number().int(),
  totalOverageMultiplierBps: z.number().int(),
...
export const ClientTrafficSchema = z.object({
  chargeDiscountBytes: z.number().int(),
  chargeExtraBytes: z.number().int(),
  down: z.number().int(),
  email: z.string(),
  enable: z.boolean(),
  expiryTime: z.number().int(),
