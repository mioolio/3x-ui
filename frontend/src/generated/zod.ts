...
export const ClientSchema = z.object({
  ...
  depletionAction: z.enum(['disable', 'throttle']).optional(),
  depletionGraceDays: z.number().int().min(0).optional(),
  depletionPeriod: z.enum(['daily', 'weekly', 'monthly']).optional(),
  depletionPeriodGB: z.number().int().min(0).optional(),
  depletionSpeed: z.number().int().min(0).optional(),
  email: z.string(),
  enable: z.boolean(),
  ...
  windowAction: z.enum(['disable', 'throttle']).optional(),
  windowMinutes: z.number().int().min(0).optional(),
  windowQuotaGB: z.number().int().min(0).optional(),
  windowSpeed: z.number().int().min(0).optional(),
});
...
export const ClientRecordSchema = z.object({
  ...
  comment: z.string(),
  createdAt: z.number().int(),
  depletionAction: z.string(),
  depletionGraceDays: z.number().int(),
  depletionPeriod: z.string(),
  depletionPeriodGB: z.number().int(),
  depletionSpeed: z.number().int(),
  email: z.string(),
  enable: z.boolean(),
  expiryTime: z.number().int(),
  flow: z.string(),
  ...
  secret: z.string(),
  security: z.string(),
  speedLimitDown: z.number().int(),
  speedLimitUp: z.number().int(),
  subId: z.string(),
  tgId: z.number().int(),
  totalGB: z.number().int(),
  ...
  uuid: z.string(),
  windowAction: z.string(),
  windowMinutes: z.number().int(),
  windowQuotaGB: z.number().int(),
  windowSpeed: z.number().int(),
});
...
export const ClientTrafficSchema = z.object({
  ...
  enable: z.boolean(),
  expiryTime: z.number().int(),
  historyDown: z.number().int(),
  historyUp: z.number().int(),
  id: z.number().int(),
  inboundId: z.number().int(),
  ...
  resetMax: z.number().int(),
  subId: z.string(),
  throttledSince: z.number().int(),
  total: z.number().int(),
  up: z.number().int(),
  uuid: z.string(),
  windowDisabled: z.boolean(),
  windowStarted: z.number().int(),
  windowUsed: z.number().int(),
});
...
export const InboundSchema = z.object({
  ...
  planAction: z.enum(['disable', 'throttle']).optional(),
  planPeriod: z.enum(['daily', 'weekly', 'monthly']).optional(),
  planQuotaGB: z.number().int().optional(),
  planSpeed: z.number().int().optional(),
  port: z.number().int().min(0).max(65535),
  ...
  windowQuotaGB: z.number().int().optional(),
  windowSpeed: z.number().int().optional(),
});
