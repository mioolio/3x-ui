...
export const ClientFormSchema = z.object({
  ...
  totalOverageMultiplierBps: z.number().int().min(10000).max(Number.MAX_SAFE_INTEGER),
  ...
  windowOverageMultiplierBps: z.number().int().min(10000).max(Number.MAX_SAFE_INTEGER),
